...
class WhatsappBotServer:
    ...
    instructions on the integration can be found here:
    https://www.mindmeld.com/docs/integrations/whatsapp.html
    """
...
if __name__ == '__main__':
    ...
    nlp.load()
    server = WhatsappBotServer(name='whatsapp', app_path='.', nlp=nlp)
    port_number = 8080
